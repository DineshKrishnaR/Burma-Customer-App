...
class Productapi {
  ...
  Future<Map<String, dynamic>?> getSubCategoryProducts(Map<String, dynamic> body) =>
      NetworkHandler.safePost(Uri.parse(base_url + getsubcategoryproducts), headers: _headers(), body: body);
  ...
  Future<Map<String, dynamic>?> ManitoSubCategory(Map<String, dynamic> body) =>
      NetworkHandler.safePost(Uri.parse(base_url + manitosubcategory), headers: _headers(), body: body);
