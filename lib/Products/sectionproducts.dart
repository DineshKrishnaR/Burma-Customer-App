...
class Sectionproducts extends StatefulWidget {
  final selected_data;
  const Sectionproducts({super.key,required this.selected_data});
 ...
 initPreferencess() async {
  ...
  Future<void> getSectionProducts() async {
   ...
   var data = {
    ...
    final response = await Productapi().getSectionProducts(data);
          ...
          Stack(
            children: [
              IconButton(
                ...
                onPressed: () async{
                  await storage.setItem('sectionproducts_cart',"sectionproducts_cart");
...
body: isLoading
        ...
        ? Center(
          ...
          : GridView.builder(
              ...
              // itemCount: section_product.length,
