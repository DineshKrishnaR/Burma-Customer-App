  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvoked: (didPop) async{
        ...
        // }else{
        Navigator.push(context, MaterialPageRoute(builder: (context)=>Maincattosubcat(selected_data: selecteddata_title,)));
        // }
      },
      child: Scaffold(
         appBar: AppBar(
          ...
          Stack(
            children: [
              IconButton(
                ...
                onPressed: () async{
                  await storage.setItem('mainsubproducts_cart',"mainsubproducts_cart");
...
int qty = cartQty[variantId] ?? 0;
  return InkWell(
        onTap: () {
          storage.setItem('main_to_sub_category_product', "main_to_sub_category_product");
      // Navigator.push(
      //   context,
      //   MaterialPageRoute(
